      ...
      <section className="py-20 bg-[#F8F9FB]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-[1fr_380px] gap-12">
            {/* Left: Form */}
            <div className="bg-white rounded-3xl p-8 sm:p-10 shadow-sm border border-border">
              <h2 className="font-display text-2xl font-bold text-midnight mb-2">Send Us a Message</h2>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-gold/10 border border-gold/20 rounded-2xl p-5 flex items-center gap-4">
                ...
                <div>
                  <p className="font-semibold text-midnight text-sm">Fast Response</p>
              ...
              <div className="bg-white rounded-2xl p-6 border border-border space-y-4">
                <h3 className="font-display font-semibold text-midnight">Contact Details</h3>
                <ul className="space-y-4">
                  <li className="flex items-start gap-3">
                    <Mail size={16} className="text-gold mt-0.5 shrink-0" />
                    <div>
                      <p className="text-xs text-muted-foreground mb-0.5">Email</p>
                      <a href={`mailto:${SITE_CONFIG.email}`} className="text-sm font-medium text-midnight hover:text-gold transition-colors">{SITE_CONFIG.email}</a>
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <a href={`tel:${SITE_CONFIG.phone}`} className="text-sm font-medium text-midnight hover:text-gold transition-colors">{SITE_CONFIG.phone}</a>
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <a href={`https://wa.me/${SITE_CONFIG.whatsappNumber}`} target="_blank" rel="noopener noreferrer" className="text-sm font-medium text-midnight hover:text-gold transition-colors">Chat on WhatsApp</a>
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm font-medium text-midnight">{SITE_CONFIG.businessHours}</p>
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm font-medium text-midnight">{SITE_CONFIG.address}</p>
                    </div>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-[#E8EDF5] rounded-2xl h-44 flex items-center justify-center border border-border">
