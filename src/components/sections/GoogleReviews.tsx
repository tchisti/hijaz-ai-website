  ...
  return (
    <section className="py-16 bg-muted/50 border-y border-border">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <h3 className="font-display text-2xl font-bold text-foreground mb-2">4.9 out of 5 stars</h3>
        <p className="text-muted-foreground mb-6">Based on 30+ verified Google Reviews from Toronto &amp; GTA clients</p>
        <Button variant="outline" asChild className="border-border text-foreground hover:bg-midnight hover:text-white">
