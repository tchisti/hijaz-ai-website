    ...
    <section className="py-24 bg-[#F8F9FB]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-14">
          ...
          <h2 className="font-display text-4xl font-bold text-midnight mt-2">Results That Speak</h2>
            ...
            >
              ...
              <div className="p-6">
                ...
                <Link href={`/portfolio#${project.id}`}
                  className="inline-flex items-center gap-1 text-sm font-medium text-midnight hover:text-gold transition-colors group-hover:gap-2">
        ...
        <div className="text-center mt-12">
          <Button asChild variant="outline" size="lg" className="border-midnight/20 text-midnight hover:bg-midnight hover:text-white transition-colors">
